...
function getRegexForGuid() {
   return new RegExp('{[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[0-9a-fA-F]{4}-[0-9a-fA-F]{12}}');
}
...
function getRegexForIPv4() {
   return new RegExp('^(([0-9]|[0-9][0-9]|[0-1][0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[0-9][0-9]|[0-1][0-9]{2}|2[0-4][0-9]|25[0-5])$');
}
...
function getRegexForSSN() {
   return new RegExp('(..[1-9]|.[1-9].|[1-9..])-(.[1-9]|[1-9].)-(...[1-9]|[1-9]...)');
}
